...
class RepositoryIf {
  public:
    ...
    virtual std::vector<Prog3::Core::Model::Column> getColumns(bool sortedByPosition = true) = 0;
    ...
    virtual std::vector<Prog3::Core::Model::Item> getItems(int columnId, bool sortedByPosition = true) = 0;
